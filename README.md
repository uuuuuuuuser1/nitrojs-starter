...
This is a template for creating a NitroJS project with Genezio. NitroJS is a modern JavaScript framework for building web applications. It is designed to be simple, fast, and easy to use.

# Deploy
:rocket: You can deploy your own version of the template to Genezio with one click:

[![Deploy to Genezio](https://raw.githubusercontent.com/Genez-io/graphics/main/svg/deploy-button.svg)](https://app.genez.io/start/deploy?repository=https://github.com/Genez-io/nitrojs-starter)
